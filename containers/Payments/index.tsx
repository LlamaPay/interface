...
import { AllScheduledPayments } from './AllScheduledPayments';
...
export const ScheduledPayments = ({
  ...
  return (
    <Layout className="flex flex-col gap-9">
      <AllScheduledPayments userAddress={finalAddress} chainId={finalChainId} isIncoming={isIncoming ? true : false} />
    </Layout>
  );
};
