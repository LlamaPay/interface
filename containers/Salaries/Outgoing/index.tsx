...
export const OutgoingSalaries = ({ userAddress, chainId }: { userAddress?: string; chainId?: number }) => {
  ...
  return (
    <Layout className="flex flex-col gap-9">
      ...
      <AllIncomeStreams userAddress={finalAddress} chainId={finalChainId} isIncoming={false} />
