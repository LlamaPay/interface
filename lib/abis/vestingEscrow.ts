const vestingEscrowABI: any = [
  ...
  { stateMutability: 'nonpayable', type: 'function', name: 'rug_pull', inputs: [], outputs: [], gas: 72184 },
  {
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  { stateMutability: 'nonpayable', type: 'function', name: 'renounce_ownership', inputs: [], outputs: [], gas: 44555 },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    name: 'collect_dust',
...
export default vestingEscrowABI;
