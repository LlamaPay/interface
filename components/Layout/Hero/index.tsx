  ...
  return (
    <div className="relative isolate flex flex-col flex-wrap gap-5 overflow-clip bg-lp-secondary p-10 text-lp-gray-5 dark:bg-lp-green-4 dark:text-lp-white sm:p-20 xl:p-24">
      ...
      <Link
        href="/salaries"
        prefetch
        className="primary-button z-10 flex w-full max-w-[26.25rem] items-center justify-center gap-4 whitespace-pre-line border-none bg-lp-white text-lg font-semibold text-lp-primary dark:bg-lp-secondary dark:text-lp-black"
      >
        <span>Dashboard</span>
        <ArrowRightIcon className="h-6" strokeWidth="2" />
      </Link>
