...
const Footer = () => {
  return (
    <footer className="relative mt-20 flex flex-col flex-wrap gap-12 bg-lp-gray-5 p-[30px] text-lp-white lg:min-h-[420px] lg:p-[60px] xl:min-h-[480px] xl:flex-row xl:justify-between xl:px-[145px] xl:py-[125px]">
      ...
      <div className="z-10 flex flex-wrap gap-12 rounded sm:gap-24 md:flex-row xl:mr-[340px] xl:text-lg 2xl:mr-[400px]">
