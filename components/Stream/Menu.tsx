...
export default function StreamMenu() {
  ...
  return (
    <>
      ...
      >
        <MenuItem
          className="flex cursor-pointer scroll-m-2 items-center justify-between gap-4 p-2 text-sm font-normal text-lp-gray-2 outline-none active-item:text-black aria-disabled:opacity-40 dark:bg-[#202020] dark:text-white dark:hover:text-[#cccccc]"
        ...
        <MenuItem className="flex scroll-m-2 items-center justify-between gap-4 p-2 text-sm font-normal text-lp-gray-2 outline-none active-item:text-black aria-disabled:opacity-40 dark:bg-[#202020] dark:hover:text-[#cccccc]">
          <WithdrawAll />
        </MenuItem>
        <MenuItem className="flex cursor-pointer scroll-m-2 items-center justify-between gap-4 p-2 text-sm font-normal text-lp-gray-2 outline-none active-item:text-black aria-disabled:opacity-40 dark:bg-[#202020] dark:text-white dark:hover:text-[#cccccc]">
